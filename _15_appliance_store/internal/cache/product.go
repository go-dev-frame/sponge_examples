...
func NewProductCache(cacheType *database.CacheType) ProductCache {
...
func (c *productCache) SetPlaceholder(ctx context.Context, id uint64) error {
	cacheKey := c.GetProductCacheKey(id)
	return c.cache.SetCacheWithNotFound(ctx, cacheKey)
}

// IsPlaceholderErr check if cache is placeholder error
func (c *productCache) IsPlaceholderErr(err error) bool {
