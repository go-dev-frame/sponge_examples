...
func productRouter(
	...
	iService storeV1.ProductLogicer) {
	storeV1.RegisterProductRouter(
		r,
		groupPathMiddlewares,
		singlePathMiddlewares,
		iService,
		storeV1.WithProductLogger(logger.Get()),
		storeV1.WithProductHTTPResponse(),
		storeV1.WithProductErrorToHTTPCode(
